...
% JPEG 2000 Core Coding System (Part 1) Majid Rabbani, Rajan L. Joshi and Paul W. Jones
\begin{enumerate}
...
\item \textbf{Lossy \& lossless:} The lossy path has a better RD curve than the lossless path.
  \vspace{-3ex}
  \begin{center}
    \includegraphics[width=0.7\textwidth]{arquitectura_J2K}
  \end{center}
...
\else
\begin{center}
        \includegraphics{lena_01_jp2}\\
        \includegraphics{lena_02_jp2}\\
        \includegraphics{lena_05_jp2}
\end{center}
...
\item Debido a la gran cantidad de datos que se generan, la
  ...
  \vspace{-1ex}
  \begin{center}
    \includegraphics[height=4.5cm]{rate-distortion}
  \end{center}
\end{itemize}
\end{comment}
...
\begin{center}
  \includegraphics[width=\textwidth]{J2K}
\end{center}
\begin{enumerate}
...
\begin{center}
  ...
  \includegraphics[width=1\textwidth]{EDQ}
\end{center}
...
\end{itemize}
\begin{center}
\includegraphics[height=\pagegoal - \pagetotal - 1 cm, draft = false]{ROI}
\end{center}
...
\item The coefficients are grouped into \textit{code-blocks} (that
  ...
  \begin{center}
    \includegraphics[height=5.5cm]{code-blocks}
  \end{center}
\newpage
...
\end{itemize}
\begin{center}
  \includegraphics[width=\textwidth]{real-EBCOT-rate-distorion}
\end{center}
...
\end{itemize}
\begin{center}
  \includegraphics[width=0.9\textwidth]{PCRD-opt}
\end{center}
...
\end{itemize}
\begin{center}
  \includegraphics[width=0.9\textwidth]{precincts}
\end{center}
...
\end{itemize}
\begin{center}
  \includegraphics[width=0.9\textwidth]{LRCP}
\end{center}
...
\end{itemize}
\begin{center}
  \includegraphics[width=0.9\textwidth]{RLCP}
\end{center}
...
\end{itemize}
\begin{center}
\includegraphics[width=0.9\textwidth]{PCRL}
\end{center}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[width=0.45\textwidth]{lena_01} &
    \includegraphics[width=0.45\textwidth]{lena_01_jp2}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[width=0.45\textwidth]{lena_02} &
    \includegraphics[width=0.45\textwidth]{lena_02_jp2}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[width=0.45\textwidth]{lena_03} &
    \includegraphics[width=0.45\textwidth]{lena_03_jp2}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[width=0.45\textwidth]{lena_04} &
    \includegraphics[width=0.45\textwidth]{lena_04_jp2}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[width=0.45\textwidth]{lena_05} &
    \includegraphics[width=0.45\textwidth]{lena_05_jp2}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[height=0.8\textheight]{cat_01} &
    \includegraphics[height=0.8\textheight]{cat_01_jp2}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[height=0.8\textheight]{cat_02} &
    \includegraphics[height=0.8\textheight]{cat_02_jp2}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[height=0.8\textheight]{cat_03} &
    \includegraphics[height=0.8\textheight]{cat_03_jp2}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[height=0.8\textheight]{cat_04} &
    \includegraphics[height=0.8\textheight]{cat_04_jp2}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \includegraphics[height=0.8\textheight]{cat_05} &
    \includegraphics[height=0.8\textheight]{cat_05_jp2}
...
\end{itemize}
\begin{center}
  \includegraphics[width=0.7\textwidth]{MJ2K_ir}
\end{center}
