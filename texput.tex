\title{The JPEG 2000 standard (ISO/IEC 15444-1)}
...
\item \textbf{Lossy \& lossless:} The lossy path has a better RD curve than the lossless path.
  \begin{center}
    \img{graphics/arquitectura_J2K.svg}
  \end{center}
\item \textbf{Quality scalability:} More decoded data, more quality.
  \begin{center}
    \img{graphics/lena_01_jp2.png}
    \img{graphics/lena_02_jp2.png}
    \img{graphics/lena_05_jp2.png}
  \end{center}
...
\item \textbf{Spatial scalability:} More decoded data, more
  ...
  \begin{center}
    \resizebox{0.9\textwidth}{!}{
      \begin{tabular}{ccc}
        \img{graphics/lena_128x128_rgb.png} & 
        \img{graphics/lena_256x256_rgb.png} & 
        \img{graphics/lena_512x512_rgb.png}
      \end{tabular}
    }
  \end{center}
...
\item \textbf{ROI (Regions Of Interest) scalability:}
  \begin{center}
    \img{graphics/lena_512x512_rgb_jp2_roi.png}
  \end{center}
...
\item Debido a la gran cantidad de datos que se generan, la
  ...
  \vspace{-1ex}
  \begin{center}
    \img{graphics/rate-distortion.svg}
  \end{center}
\end{itemize}
\end{comment}
...
\begin{center}
  ...
  \begin{tabular}{cccccc}
    ...
    \fbox{\img{graphics/lena_plano14.png}}&
    \fbox{\img{graphics/lena_rec14.png}}&
    \fbox{\img{graphics/lena_plano13.png}}&
    \fbox{\img{graphics/lena_rec13.png}}&
    \fbox{\img{graphics/lena_plano12.png}}&
    \fbox{\img{graphics/lena_rec12.png}}\\
    \fbox{\img{graphics/lena_plano11.png}}&
    \fbox{\img{graphics/lena_rec11.png}}&
    \fbox{\img{graphics/lena_plano10.png}}&
    \fbox{\img{graphics/lena_rec10.png}}&
    \fbox{\img{graphics/lena_plano9.png}}&
    \fbox{\img{graphics/lena_rec9.png}}\\
    \fbox{\img{graphics/lena_plano8.png}}&
    \fbox{\img{graphics/lena_rec8.png}}&
    \fbox{\img{graphics/lena_plano7.png}}&
    \fbox{\img{graphics/lena_rec7.png}}&
    \fbox{\img{graphics/lena_plano6.png}}&
    \fbox{\img{graphics/lena_rec6.png}}\\
    \fbox{\img{graphics/lena_plano5.png}}&
    \fbox{\img{graphics/lena_rec5.png}}&
    \fbox{\img{graphics/lena_plano4.png}}&
    \fbox{\img{graphics/lena_rec4.png}}&
    \fbox{\img{graphics/lena_plano3.png}}&
    \fbox{\img{graphics/lena_rec3.png}}\\
    \fbox{\img{graphics/lena_plano2.png}}&
    \fbox{\img{graphics/lena_rec2.png}}&
    \fbox{\img{graphics/lena_plano1.png}}&
    \fbox{\img{graphics/lena_rec1.png}}&
    \fbox{\img{graphics/lena_plano0.png}}&
    \fbox{\img{graphics/lena_rec0}}
...
\item The coefficients are grouped into \textit{code-blocks} (that
  ...
  \begin{center}
    \imgw{400}{graphics/code-blocks.svg}
  \end{center}
\newpage
...
\end{itemize}
\begin{center}
  \imgw{600}{graphics/real-EBCOT-rate-distorion.svg}
\end{center}
...
\end{itemize}
\begin{center}
  \imgw{800}{graphics/PCRD-opt.svg}
\end{center}
...
\end{itemize}
\begin{center}
  \imgw{600}{graphics/precincts.svg}
\end{center}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \img{graphics/cat_01.jpg} &
    \img{graphics/cat_01_jp2.png}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \img{graphics/cat_02.jpg} &
    \img{graphics/cat_02_jp2.png}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \img{graphics/cat_03.jpg} &
    \img{graphics/cat_03_jp2.png}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \img{graphics/cat_04.jpg} &
    \img{graphics/cat_04_jp2.png}
...
\begin{center}
  \begin{tabular}{cc}
    ...
    \img{graphics/cat_05.jpg} &
    \img{graphics/cat_05_jp2.png}
